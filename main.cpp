...
// TODO thread safe logs?

// TODO в виде гугл тестов предоставить пруфы что
// дедлок провоцируется то одним, то другим потоком.
// забенчмаркать среднее время выполнения программы,
// привести график, как работают потоки

// i - id of simulation
// P/C - who caused deadlock
//
// show the distribution of P/C values
// show time pots t(i)
// тесты тут вряд ли нужны! нет смысла, нечего проверять.

// ИДЕЯ для теста - проверить, что логгер был либо одной формы,
// ибо другой (первое слово последнего лога) - в тесте использовать
// файловый логгер;в обоих случаях, мы проверяем, что логгер либо снизил до 0,
// либо увеичил до 10

// простой способ проверить дедлок - таймаут, и все, если ничего не происходит
// с очередью, то есть дедлок. как проверять? надо кешировать тайм стемп
// последнего запроса
